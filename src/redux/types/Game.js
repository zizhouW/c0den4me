...
export const START_QUEUE_LOADING = `START_QUEUE_${BASE_TYPES.LOADING}`;
export const START_QUEUE_SUCCESS = `START_QUEUE_${BASE_TYPES.SUCCESS}`;
export const START_QUEUE_ERROR = `START_QUEUE_${BASE_TYPES.ERROR}`;
